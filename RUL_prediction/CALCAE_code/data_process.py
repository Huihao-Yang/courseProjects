        ...
        for p in path_sorted:
            ...
            for c in cycles:
                ...
                if (len(list(d_c)) != 0):  # 如果存在放电数据
                    ...
                    count += 1
        #             if count in [100, 300, 500, 700]:
        #                 df_lim.to_csv('./dataset/params_data/' + 'CS2_35-' + str(count) + '.csv', index=False)
        # break
